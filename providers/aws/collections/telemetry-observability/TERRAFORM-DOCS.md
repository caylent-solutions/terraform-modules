...
| <a name="input_opensearch_access_policies_json"></a> [opensearch\_access\_policies\_json](#input\_opensearch\_access\_policies\_json) | Access policy document (JSON-encoded). Null uses the primitive's default. | `string` | `null` | no |
| <a name="input_opensearch_availability_zone_count"></a> [opensearch\_availability\_zone\_count](#input\_opensearch\_availability\_zone\_count) | Number of AZs to spread the cluster across when zone awareness is enabled. | `number` | `null` | no |
| <a name="input_opensearch_dedicated_master_count"></a> [opensearch\_dedicated\_master\_count](#input\_opensearch\_dedicated\_master\_count) | Number of dedicated master nodes. | `number` | `null` | no |
...
| <a name="input_opensearch_dedicated_master_type"></a> [opensearch\_dedicated\_master\_type](#input\_opensearch\_dedicated\_master\_type) | Instance type for dedicated master nodes. | `string` | `null` | no |
...
| <a name="input_opensearch_tls_security_policy"></a> [opensearch\_tls\_security\_policy](#input\_opensearch\_tls\_security\_policy) | TLS security policy for the domain endpoint. | `string` | `"Policy-Min-TLS-1-2-2019-07"` | no |
| <a name="input_opensearch_vpc_security_group_ids"></a> [opensearch\_vpc\_security\_group\_ids](#input\_opensearch\_vpc\_security\_group\_ids) | Security groups for VPC-mode deployment. | `list(string)` | `null` | no |
