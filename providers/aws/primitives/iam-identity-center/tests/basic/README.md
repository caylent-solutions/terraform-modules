...
In this case, tests are limited given that the control tower controls requires the usage of a management account in an organization with control tower enabled.
