...
| <a name="input_ext_env_var_cache_enabled"></a> [ext\_env\_var\_cache\_enabled](#input\_ext\_env\_var\_cache\_enabled) | Environment variable name for enabling the extension cache | `string` | `"PARAMETERS_SECRETS_EXTENSION_CACHE_ENABLED"` | no |
| <a name="input_ext_env_var_cache_size"></a> [ext\_env\_var\_cache\_size](#input\_ext\_env\_var\_cache\_size) | Environment variable name for the extension cache size | `string` | `"PARAMETERS_SECRETS_EXTENSION_CACHE_SIZE"` | no |
| <a name="input_ext_env_var_http_port"></a> [ext\_env\_var\_http\_port](#input\_ext\_env\_var\_http\_port) | Environment variable name for the extension HTTP port | `string` | `"PARAMETERS_SECRETS_EXTENSION_HTTP_PORT"` | no |
| <a name="input_ext_env_var_max_connections"></a> [ext\_env\_var\_max\_connections](#input\_ext\_env\_var\_max\_connections) | Environment variable name for the extension max connections | `string` | `"PARAMETERS_SECRETS_EXTENSION_MAX_CONNECTIONS"` | no |
| <a name="input_ext_env_var_secrets_timeout"></a> [ext\_env\_var\_secrets\_timeout](#input\_ext\_env\_var\_secrets\_timeout) | Environment variable name for the Secrets Manager timeout | `string` | `"SECRETS_MANAGER_TIMEOUT_MILLIS"` | no |
| <a name="input_ext_env_var_ssm_timeout"></a> [ext\_env\_var\_ssm\_timeout](#input\_ext\_env\_var\_ssm\_timeout) | Environment variable name for the SSM Parameter Store timeout | `string` | `"SSM_PARAMETER_STORE_TIMEOUT_MILLIS"` | no |
| <a name="input_ext_layer_arn_pattern_arm64"></a> [ext\_layer\_arn\_pattern\_arm64](#input\_ext\_layer\_arn\_pattern\_arm64) | ARN format pattern for the arm64 Parameters and Secrets Lambda Extension layer | `string` | `"arn:aws:lambda:%s:%s:layer:AWS-Parameters-and-Secrets-Lambda-Extension-Arm64:%d"` | no |
| <a name="input_ext_layer_arn_pattern_x86_64"></a> [ext\_layer\_arn\_pattern\_x86\_64](#input\_ext\_layer\_arn\_pattern\_x86\_64) | ARN format pattern for the x86\_64 Parameters and Secrets Lambda Extension layer | `string` | `"arn:aws:lambda:%s:%s:layer:AWS-Parameters-and-Secrets-Lambda-Extension:%d"` | no |
| <a name="input_ext_layer_version"></a> [ext\_layer\_version](#input\_ext\_layer\_version) | AWS Parameters and Secrets Lambda Extension layer version number | `number` | `11` | no |
...
| <a name="output_architectures"></a> [architectures](#output\_architectures) | Instruction set architecture list for the Lambda function |
